...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxUiToolingPreviewLibraryAccessors extends SubDependencyFactory {
        ...
        public AndroidxUiToolingPreviewLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for desktop (androidx.compose.ui:ui-tooling-preview-desktop)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getDesktop() {
                return create("androidx.ui.tooling.preview.desktop");
        }
    ...
    public static class KotlinLibraryAccessors extends SubDependencyFactory {
        private final KotlinLoggingLibraryAccessors laccForKotlinLoggingLibraryAccessors = new KotlinLoggingLibraryAccessors(owner);
        ...
        /**
         * Returns the group of libraries at kotlin.logging
         */
        public KotlinLoggingLibraryAccessors getLogging() {
            return laccForKotlinLoggingLibraryAccessors;
        }
    ...
    public static class KotlinLoggingLibraryAccessors extends SubDependencyFactory {

        public KotlinLoggingLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            public Provider<MinimalExternalModuleDependency> getJvm() {
                return create("kotlin.logging.jvm");
        }
    ...
    public static class MediaLibraryAccessors extends SubDependencyFactory {
        ...
        public MediaLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for kamel (media.kamel:kamel-image)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getKamel() {
                return create("media.kamel");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: kotlinLoggingJvm (5.0.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getKotlinLoggingJvm() { return getVersion("kotlinLoggingJvm"); }
            ...
            /**
             * Returns the version associated to this alias: logbackClassic (1.4.11)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: mvvmCore (0.13.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: uiToolingPreviewAndroid (1.6.6)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: uiToolingPreviewDesktop (1.6.6)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getUiToolingPreviewDesktop() { return getVersion("uiToolingPreviewDesktop"); }
