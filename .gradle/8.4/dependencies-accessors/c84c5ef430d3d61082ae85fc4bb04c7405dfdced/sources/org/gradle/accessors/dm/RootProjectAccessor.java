...
public class RootProjectAccessor extends TypeSafeProjectDependencyFactory {
     ...
     */
    public ComposeMultiplatformWeatherAppProjectDependency getComposeMultiplatformWeatherApp() { return new ComposeMultiplatformWeatherAppProjectDependency(getFactory(), create(":")); }
